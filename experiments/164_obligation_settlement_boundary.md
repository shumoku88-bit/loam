# Observation 164: Do shared-cost settlement and deferred card payment share a smaller obligation / settlement boundary?
...
Observation 163 remains an independent open observation. This model is intentionally based directly on `main` and does not assume Observation 163's candidate vocabulary is already accepted.
