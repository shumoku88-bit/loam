# Observation 163: Does recurring shared-cost settlement require a Reimbursement concept, or a more general burden boundary?
...
The repeated canonical `payment account + / transport expense -` events may remain valid movement evidence. Observation 163 does not authorize rewriting them.
