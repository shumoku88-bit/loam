...
namespace Loam.Observation160Contract
...
/-!
# Observation 160 contract — statement alignment boundary
...
lives separately in `Observation160.lean`.
...
end Loam.Observation160Contract
