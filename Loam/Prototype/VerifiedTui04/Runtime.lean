...
build or scan a complete dense screen.
-/
...
/--
Semantic patch represented by dirty rows. This is specification-only: terminal
adapters can iterate `dirtyRows` directly instead of testing every screen cell.
-/
