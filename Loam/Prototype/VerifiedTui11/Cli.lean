...
namespace Loam.Prototype.VerifiedTui11.Cli

open Loam.Prototype.VerifiedTui04.Runtime
open Loam.Prototype.VerifiedTui11.Main
...
private def resolveDataDir (args : List String) : IO (Except String System.FilePath) := do
  ...
  | [path] =>
      ...
      return .ok (System.FilePath.mk path)
  | _ =>
      return .error "usage: loamUiPrototype11 [LOAM_DATA_DIR]"
...
end Loam.Prototype.VerifiedTui11.Cli


def main (args : List String) : IO UInt32 :=
  Loam.Prototype.VerifiedTui11.Cli.run args
