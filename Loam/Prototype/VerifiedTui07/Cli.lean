...
import Loam.Prototype.VerifiedTui07.Main

namespace Loam.Prototype.VerifiedTui07.Cli

open Loam.Prototype.VerifiedTui04.Kernel
open Loam.Prototype.VerifiedTui04.Runtime
open Loam.Prototype.VerifiedTui07.Main
...
private def resolveDataDir (args : List String) : IO (Except String System.FilePath) := do
  ...
  | [path] =>
      ...
      return .ok (System.FilePath.mk path)
  | _ =>
      return .error "usage: loamUiPrototype07 [LOAM_DATA_DIR]"
...
/--
Lower each damaged logical row as one contiguous terminal stream. This retains
the Unicode-safe terminal behavior qualified by Prototype 06 while leaving
logical-cell width outside the proved kernel.
-/
...
end Loam.Prototype.VerifiedTui07.Cli

def main (args : List String) : IO UInt32 :=
  Loam.Prototype.VerifiedTui07.Cli.run args
