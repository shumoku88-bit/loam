...
open Loam.Prototype.VerifiedTui10.Main
...
private def resolveDataDir (args : List String) : IO (Except String System.FilePath) := do
  ...
  | [path] =>
      ...
      return .ok (System.FilePath.mk path)
  | _ =>
      return .error "usage: loamUiPrototype10 [LOAM_DATA_DIR]"
...
end Loam.Prototype.VerifiedTui10.Cli


def main (args : List String) : IO UInt32 :=
  Loam.Prototype.VerifiedTui10.Cli.run args
