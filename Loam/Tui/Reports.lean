import Loam.Tui.ReportsInteraction
...
Rendering consumes the interaction/state boundary from `ReportsInteraction`.
It owns no report semantics or household authority.
-/
